...
import gr.aueb.cf.schoolapp.exceptions.TeacherAlreadyExistException;
import gr.aueb.cf.schoolapp.model.City;
import gr.aueb.cf.schoolapp.service.CityServiceImpl;
import gr.aueb.cf.schoolapp.service.ICityService;
import gr.aueb.cf.schoolapp.service.ITeacherService;
import gr.aueb.cf.schoolapp.service.TeacherServicesImpl;
...
//	private JLabel errorEmail;
	...
	private final ITeacherService teacherService = new TeacherServicesImpl(teacherDAO);
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowActivated(WindowEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null,"Get cities Fatal error" +
...
////				errorEmail.setText("");
		...
		JLabel firstLastName = new JLabel("ΧΡΗΣΤΟΣ ΤΑΡΤΑΡΙ");
...
//				
//				errorVat.setText(inputVat.equals("")? "το ΑΦΜ ειναι υποχρεωτικο": "");
//			}
//		});
		...
		insertBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null,"Teacher with uuid:"
							+ teacherReadOnlyDTO.getUuid(),"Insert",JOptionPane.INFORMATION_MESSAGE);
					// to do form instead of message dialog
				} catch (TeacherDAOException | TeacherAlreadyExistException ex) {
