...
public class TeacherServicesImpl implements ITeacherService {

    private final ITeacherDAO teacherDAO;

    public TeacherServicesImpl(ITeacherDAO teacherDAO) {
        this.teacherDAO = teacherDAO;
    }

    @Override
    public TeacherReadOnlyDTO insertTeacher(TeacherInsertDTO dto)
            throws TeacherDAOException, TeacherAlreadyExistException {
        Teacher teacher;
        ...
        try {
            ...
            if (teacherDAO.getTeacherByVat(dto.getVat()) != null)
                throw new TeacherAlreadyExistException("Teacher with vat:" + dto.getVat() + " already exists");
        ...
        } catch (TeacherDAOException | TeacherAlreadyExistException e){
            // Logging
            // rollback
            throw e;
        }
    ...
    public TeacherReadOnlyDTO updateTeacher(Integer id, TeacherUpdateDTO dto)
            throws TeacherDAOException, TeacherAlreadyExistException, TeacherNotFoundException {
        Teacher teacher;
        ...
        try {
            ...
            if (fetchedTeacher != null && !fetchedTeacher.getId().equals(dto.getId())) {
                throw new TeacherAlreadyExistException("Teacher with id:" + id + " already exists!");
            }
            ...
            // logging
            return Mapper
                    .mapTeacherToReadOnlyDTO(updatedTeacher).
                    orElseThrow(() -> new TeacherDAOException("Error during mapping"));
        } catch (TeacherDAOException | TeacherAlreadyExistException |TeacherNotFoundException e){
            // Logging
            // rollback
            throw e;
        }
    ...
    public TeacherReadOnlyDTO getTeacherById(Integer id) throws TeacherDAOException, TeacherNotFoundException {
        ...
        try {
            ...
            return Mapper
                    .mapTeacherToReadOnlyDTO(teacher)
    ...
    public List<TeacherReadOnlyDTO> getAllTeachers() throws TeacherDAOException {
        ...
        try {
            ...
            return teachers.stream()
                    .map(Mapper::mapTeacherToReadOnlyDTO) //Method References
