...
public class TeacherDAOImpl implements  ITeacherDAO{
    ...
    public Teacher update(Teacher teacher) throws TeacherDAOException {
        String sql = "UPDATE INTO teachers SET firstname = ?, lastname = ?, vat = ? , fathername = ?, phone_num = ?, email = ?, street = ?, " +
                " street_num = ?, zipcode = ?, city_id = ?, updated_at = ? " +
                "WHERE id = ?";
    ...
    public List<Teacher> getAll() throws TeacherDAOException {
        ...
        try(Connection connection = DBUtil.getConnection();
            ...
            while (rs.next()){
                teacher = new Teacher(rs.getInt("id"), rs.getString("firstname"), rs.getString("lastname"),
                        rs.getString("vat"), rs.getString("fathername"), rs.getString("phoneNum"),
                        rs.getString("email"), rs.getString("street"), rs.getString("street_num"),
                        rs.getString("zipcode"), rs.getInt("city_id"), rs.getString("uuid"),
                        rs.getTimestamp("created_at").toLocalDateTime(), rs.getTimestamp("updated_at").toLocalDateTime());
